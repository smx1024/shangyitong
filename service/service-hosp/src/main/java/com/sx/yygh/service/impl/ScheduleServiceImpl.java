...
import com.sx.yygh.mapper.ScheduleMapper;
import com.sx.yygh.model.hosp.BookingRule;
...
import com.sx.yygh.repository.ScheduleRepository;
...
import com.sx.yygh.vo.hosp.BookingScheduleRuleVo;
...
public class ScheduleServiceImpl extends
    ...
    public void save(Map<String, Object> paramMap) {
        ...
        Schedule  schedule1=scheduleRepository.getScheduleByHoscodeAndHosScheduleId(depcode,hoscode);
        if (null==schedule1){
...
//创建匹配器，即如何使用查询条件
    ...
    public List<Schedule> getDetailSchedule(String hoscode, String depcode, String workDate) {
        Date dateTime = new DateTime(workDate).toDate();
        List<Schedule> scheduleList = scheduleRepository.findScheduleByHoscodeAndDepcodeAndWorkDate(hoscode, depcode, dateTime);
...
//    private Schedule getByScheduleId(String scheduleId) {
//    Schedule schedule = scheduleRepository.findScheduleByHosScheduleId(scheduleId).get(0);
//        this.packageSchedule(schedule);
//        return schedule;
//    }
}
