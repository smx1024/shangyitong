...
import com.sx.yygh.vo.hosp.HospitalSetQueryVo;
...
public class HospitalSetController {
    ...
    public Result removeHospSet(@PathVariable Long id){
        QueryWrapper  queryWrapper = new QueryWrapper<HospitalSet>().eq("id", id);
        boolean b = hospitalSetService.remove(queryWrapper);
        if (b){
            return  Result.ok();
        }
        else {
